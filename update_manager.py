...
class UpdateManager:
    def __init__(self, current_version="2.1.1", repo="AnkitB018/Business-Dashboard"):
...
def check_for_updates_async(parent_window=None, current_version="2.1.1", show_no_update=True):
